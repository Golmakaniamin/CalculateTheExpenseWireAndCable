...
Dim Report1 As New nahaii1
Dim Report2 As New nahaii2
Dim Report3 As New nahaii3
...
If Label1.Caption = 2 Then
  ...
  Report2.Text15.SetText Form11.Text1(0).Text
  Report2.Text17.SetText Form11.Text1(1).Text
  Report2.Text21.SetText Form11.Text1(2).Text
  Report2.Text20.SetText Form11.Text1(3).Text
