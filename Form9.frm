...
Begin VB.Form Form9 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab             =   1
      TabHeight       =   520
      TabCaption(0)   =   "ÃœÊ· ﬁÌ„  „ﬁœ«—Ì —Ì«·Ì"
      TabPicture(0)   =   "Form9.frx":2CFA
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "DataGrid2"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "ÃœÊ· ﬁÌ„   „«„ ‘œÂ Ê«Õœ"
      TabPicture(1)   =   "Form9.frx":2D16
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "ÃœÊ· „ﬁœ«—"
      TabPicture(2)   =   "Form9.frx":2D32
...
Form3.Adodc2.Recordset.Find "name='rad'", , adSearchForward, 1
Form26.Adodc4.Recordset.Find "rad=" + Form3.Adodc2.Recordset.Fields!store5, , adSearchForward, 1

Form7.Adodc1.RecordSource = "Select * From ghardeshmavad Where (nomade=1) and (idmade=1)"
Form7.Adodc1.Refresh
Form3.Adodc2.Recordset.Fields!store1 = Form7.Adodc1.Recordset.Fields!masrafteydoremablagh
...
Form9.Text1(0).Text = Form3.Adodc2.Recordset.Fields!store1
Form9.Text1(1).Text = Form3.Adodc2.Recordset.Fields!store2
Form9.Text1(2).Text = Form3.Adodc2.Recordset.Fields!store3
Form9.Text1(3).Text = Form3.Adodc2.Recordset.Fields!store4

Form7.Adodc1.RecordSource = "Select * From ghardeshmavad Where (nomade=1) and (idmade=1)"
Form7.Adodc1.Refresh
newq = Form7.Adodc1.Recordset.Fields!masrafteydoremeghdar

Form7.Adodc1.RecordSource = "Select * From rad Where (rad=99999)"
Form7.Adodc1.Refresh
newq2 = Form7.Adodc1.Recordset.Fields!mezantolidmostaghim


Adodc3.CommandType = adCmdUnknown
Adodc3.RecordSource = "SELECT sum(tolidteydoremeghdar) as tolidteydoremeghdar1 FROM rad WHERE (rad <> 99999) and (rad <> 99998)"
Adodc3.Refresh
newq1 = Adodc3.Recordset.Fields!tolidteydoremeghdar1

Adodc3.CommandType = adCmdUnknown
Adodc3.RecordSource = "select * from rad ORDER BY rad ASC"
Adodc3.Refresh

Adodc3.Recordset.Find "rad=99998", , adSearchForward, 1
Adodc3.Recordset.Fields!tolidteydoremeghdar = newq - newq1
...
Do
   If (Adodc3.Recordset.Fields!rad <> 99999) And (Adodc3.Recordset.Fields!rad <> 99998) Then
      'ÃœÊ· „ﬁœ«—Ì
      If Adodc3.Recordset.Fields!Name = "À«‰ÊÌÂ" Then
        Form10.Adodc3.ConnectionString = Form3.Text10.Text
        Form10.Adodc3.CommandType = adCmdUnknown
        Form10.Adodc3.RecordSource = "select * from sanaveye WHERE (rad=99999)"
      ...
      If ((Val(q) + Val(e)) * Adodc3.Recordset.Fields!mojodiendmeghdar) <> 0 Then
        sd = Round((Val(w) + Val(r)) / (Val(q) + Val(e)) * Adodc3.Recordset.Fields!mojodiendmeghdar)
        Adodc3.Recordset.Fields!mojodiendmoney = sd
      Else
      ...
      '„Ê«œ «Ê·ÌÂ
      If newq <> 0 Then
        r = (Val(Text1(0).Text) / newq2) * Adodc3.Recordset.Fields!mezantolidmostaghim
      ...
      Adodc3.Recordset.Update
   ElseIf (Adodc3.Recordset.Fields!rad = 99998) Then
      'ÃœÊ· „ﬁœ«—Ì
      q = Adodc3.Recordset.Fields!mojodiavalmeghdar
      w = Adodc3.Recordset.Fields!tolidteydoremeghdar
      e = Adodc3.Recordset.Fields!mojodiendmeghdar
      Adodc3.Recordset.Fields!naghlbebadmeghdar = (Val(q) + Val(w)) - Val(e)
...
Form30.Label1.Caption = 1
Form30.Show
End Sub

Private Sub Command3_Click()
Form30.Label1.Caption = 2
Form30.Show
End Sub

Private Sub Command4_Click()
Form30.Label1.Caption = 3
Form30.Show
End Sub
...
List1.Visible = False
Form9.Adodc1.ConnectionString = Form3.Text10.Text
Form9.Adodc1.CommandType = adCmdUnknown
Form9.Adodc1.RecordSource = "select * from rad ORDER BY rad ASC"
...
If (Val(Adodc1.Recordset.Fields!rad) <> 99999) And (Val(Adodc1.Recordset.Fields!rad) <> 99998) Then
  DataGrid3.Col = 1
