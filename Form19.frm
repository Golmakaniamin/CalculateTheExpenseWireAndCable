...
Begin VB.Form Form19 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(3)   =   "Form19.frx":2D4E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "DataGrid4"
      Tab(3).ControlCount=   1
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "Form19.frx":2D6A
         Height          =   8415
         Left            =   -74880
         TabIndex        =   12
         Top             =   480
...
If Combo1.ListIndex = 0 Then
  ...
  Adodc1.RecordSource = "select * from Mokhaberat ORDER BY idmahsol,rad ASC"
  Adodc1.Refresh
  
  db1.Open Form3.Text10.Text
    rs1(0).Open "SELECT sum(vaznmes) as vaznmes1,sum(bahamavad) as bahamavad1_1,sum(bahamavad1) as bahamavad11,sum(dastmozd) as dastmozd1,sum(sarbar) as sarbar1,sum(estelak) as estelak1,sum(gheymattamam) as gheymattamam1,sum(mojodiavalmeghdar) as mojodiavalmeghdar1, sum(mojodiavalmemoney) as mojodiavalmemoney1,sum(tolidteydoremeghdar) as tolidteydoremeghdar1,sum(tolidteydoremoney) as tolidteydoremoney1,sum(naghlbebadmoney) as naghlbebadmoney1,sum(naghlbebadmeghdar) as naghlbebadmeghdar1,sum(mojodiendmeghdar) as mojodiendmeghdar1,sum(mojodiendmoney) as mojodiendmoney1 FROM Mokhaberat WHERE (rad <> 99999)", db1
      db2.Open Form3.Text10.Text
        rs1(5).Open "UPDATE Mokhaberat SET [vaznmes]=" + Trim(Str(rs1(0).Fields!vaznmes1)) + ",[bahamavad]=" + Trim(Str(rs1(0).Fields!bahamavad1_1)) + ",[bahamavad1]=" + Trim(Str(rs1(0).Fields!bahamavad11)) + ",[dastmozd]=" + Trim(Str(rs1(0).Fields!dastmozd1)) + ",[sarbar]=" + Trim(Str(rs1(0).Fields!sarbar1)) + ",[estelak]=" + Trim(Str(rs1(0).Fields!estelak1)) + ",[gheymattamam]=" + Trim(Str(rs1(0).Fields!gheymattamam1)) + ",[mojodiavalmeghdar]=" + Trim(Str(rs1(0).Fields!mojodiavalmeghdar1)) + ",[mojodiavalmemoney]=" + Trim(Str(rs1(0).Fields!mojodiavalmemoney1)) + ",[tolidteydoremeghdar]=" + Trim(Str(rs1(0).Fields!tolidteydoremeghdar1)) + ",[tolidteydoremoney]=" + Trim(Str(rs1(0).Fields!tolidteydoremoney1)) + ",[naghlbebadmoney]=" + Trim(Str(rs1(0).Fields!naghlbebadmoney1)) + ",[naghlbebadmeghdar]=" + Trim(Str(rs1(0).Fields!naghlbebadmeghdar1)) + ",[mojodiendmeghdar]=" + Trim(Str(rs1(0).Fields!mojodiendmeghdar1)) + ",[mojodiendmoney]=" + Trim(Str(rs1(0).Fields!mojodiendmoney1)) + " WHERE (rad=99999)", db2
      db2.Close
    rs1(0).Close
  db1.Close
...
Else
  Adodc1.ConnectionString = Form3.Text10.Text
  Adodc1.CommandType = adCmdUnknown
  Adodc1.RecordSource = "SELECT * FROM Mokhaberat WHERE (gothr='" + Combo1.Text + "') or (rad=99999) ORDER BY idmahsol,rad ASC"
  Adodc1.Refresh
  
  db1.Open Form3.Text10.Text
    rs1(0).Open "SELECT sum(vaznmes) as vaznmes1,sum(bahamavad) as bahamavad1_1,sum(bahamavad1) as bahamavad11,sum(dastmozd) as dastmozd1,sum(sarbar) as sarbar1,sum(estelak) as estelak1,sum(gheymattamam) as gheymattamam1,sum(mojodiavalmeghdar) as mojodiavalmeghdar1, sum(mojodiavalmemoney) as mojodiavalmemoney1,sum(tolidteydoremeghdar) as tolidteydoremeghdar1,sum(tolidteydoremoney) as tolidteydoremoney1,sum(naghlbebadmoney) as naghlbebadmoney1,sum(naghlbebadmeghdar) as naghlbebadmeghdar1,sum(mojodiendmeghdar) as mojodiendmeghdar1,sum(mojodiendmoney) as mojodiendmoney1 FROM Mokhaberat WHERE (gothr='" + Combo1.Text + "') AND (rad <> 99999)", db1
      db2.Open Form3.Text10.Text
        rs1(5).Open "UPDATE Mokhaberat SET [vaznmes]=" + Trim(Str(rs1(0).Fields!vaznmes1)) + ",[bahamavad]=" + Trim(Str(rs1(0).Fields!bahamavad1_1)) + ",[bahamavad1]=" + Trim(Str(rs1(0).Fields!bahamavad11)) + ",[dastmozd]=" + Trim(Str(rs1(0).Fields!dastmozd1)) + ",[sarbar]=" + Trim(Str(rs1(0).Fields!sarbar1)) + ",[estelak]=" + Trim(Str(rs1(0).Fields!estelak1)) + ",[gheymattamam]=" + Trim(Str(rs1(0).Fields!gheymattamam1)) + ",[mojodiavalmeghdar]=" + Trim(Str(rs1(0).Fields!mojodiavalmeghdar1)) + ",[mojodiavalmemoney]=" + Trim(Str(rs1(0).Fields!mojodiavalmemoney1)) + ",[tolidteydoremeghdar]=" + Trim(Str(rs1(0).Fields!tolidteydoremeghdar1)) + ",[tolidteydoremoney]=" + Trim(Str(rs1(0).Fields!tolidteydoremoney1)) + ",[naghlbebadmoney]=" + Trim(Str(rs1(0).Fields!naghlbebadmoney1)) + ",[naghlbebadmeghdar]=" + Trim(Str(rs1(0).Fields!naghlbebadmeghdar1)) + ",[mojodiendmeghdar]=" + Trim(Str(rs1(0).Fields!mojodiendmeghdar1)) + ",[mojodiendmoney]=" + Trim(Str(rs1(0).Fields!mojodiendmoney1)) + " WHERE (rad=99999)", db2
      db2.Close
    rs1(0).Close
...
db2.Open Form3.Text10.Text
  rs1(0).Open "DELETE FROM Mokhaberat1", db2
db2.Close

q = 1
w = 0
db1.Open Form3.Text10.Text
  rs1(0).Open "SELECT count(rad) As rs1number FROM rad WHERE Name = '„Œ«»—« Ì'", db1
     rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "SELECT * FROM rad WHERE Name = '„Œ«»—« Ì'", db1
      rs1(0).MoveFirst
      Do
        ...
        End If
        db2.Open Form3.Text10.Text
          rs1(1).Open "INSERT INTO Mokhaberat1 (rad,Name,Name1,ghotr,vazn,mablag,fey) VALUES (" + Trim(Str(q)) + ",'" + "—«œ" + "','" + "1" + "','" + rs1(0).Fields!ghotr + "','" + rs1(0).Fields!naghlbebadmeghdar + "','" + rs1(0).Fields!naghlbebadmoney + "','" + sd + "')", db2
        db2.Close
        q = q + 1
        rs1(0).MoveNext
  ...
  rs1(0).Open "SELECT count(rad) As rs1number FROM sanaveye WHERE Name = '„Œ«»—« Ì'", db1
     rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "SELECT * FROM sanaveye WHERE Name = '„Œ«»—« Ì'", db1
      rs1(0).MoveFirst
      Do
        w = Val(w) + Val(rs1(0).Fields!naghlbebadmoney)
        If rs1(0).Fields!naghlbebadmeghdar <> 0 Then
        ...
        End If
        db2.Open Form3.Text10.Text
          rs1(1).Open "INSERT INTO Mokhaberat1 (rad,Name,Name1,ghotr,vazn,mablag,fey) VALUES (" + Trim(Str(q)) + ",'" + "À«‰ÊÌÂ" + "','" + "1" + "','" + rs1(0).Fields!ghotr + "','" + rs1(0).Fields!naghlbebadmeghdar + "','" + rs1(0).Fields!naghlbebadmoney + "','" + sd + "')", db2
        db2.Close
        q = q + 1
        rs1(0).MoveNext
      Loop Until rs1(0).EOF = True
  ...
  rs1(0).Open "SELECT count(rad) As rs1number FROM nahaee WHERE Name = '„Œ«»—« Ì'", db1
     rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "SELECT * FROM nahaee WHERE Name = '„Œ«»—« Ì'", db1
      rs1(0).MoveFirst
      Do
        w = Val(w) + Val(rs1(0).Fields!naghlbebadmoney)
        If rs1(0).Fields!naghlbebadmeghdar <> 0 Then
        ...
        End If
        db2.Open Form3.Text10.Text
          rs1(1).Open "INSERT INTO Mokhaberat1 (rad,Name,Name1,ghotr,vazn,mablag,fey) VALUES (" + Trim(Str(q)) + ",'" + "‰Â«ÌÌ" + "','" + "1" + "','" + rs1(0).Fields!ghotr + "','" + rs1(0).Fields!naghlbebadmeghdar + "','" + rs1(0).Fields!naghlbebadmoney + "','" + sd + "')", db2
        db2.Close
        q = q + 1
        rs1(0).MoveNext
      Loop Until rs1(0).EOF = True
  ...
  rs1(0).Open "SELECT count(rad) As rs1number FROM Koreh WHERE Name = '„Œ«»—« Ì'", db1
     rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "SELECT * FROM Koreh WHERE Name = '„Œ«»—« Ì'", db1
      rs1(0).MoveFirst
      Do
        w = Val(w) + Val(rs1(0).Fields!naghlbebadmoney)
        If rs1(0).Fields!naghlbebadmeghdar <> 0 Then
        ...
        End If
        db2.Open Form3.Text10.Text
          rs1(1).Open "INSERT INTO Mokhaberat1 (rad,Name,Name1,ghotr,vazn,mablag,fey) VALUES (" + Trim(Str(q)) + ",'" + "òÊ—Â" + "','" + "1" + "','" + rs1(0).Fields!ghotr + "','" + rs1(0).Fields!naghlbebadmeghdar + "','" + rs1(0).Fields!naghlbebadmoney + "','" + sd + "')", db2
        db2.Close
        q = q + 1
        rs1(0).MoveNext
      Loop Until rs1(0).EOF = True
...
Adodc5.RecordSource = "SELECT * FROM Mokhaberat1 ORDER BY rad"
Adodc5.Refresh
db1.Close

db1.Open Form3.Text10.Text
  rs1(0).Open "SELECT count(rad) As rs1number FROM ozanmasir WHERE name='„Œ«»—« Ì'", db1
     rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "SELECT * FROM ozanmasir WHERE name='„Œ«»—« Ì'", db1
       ProgressBar1.Min = 0
       ...
       Do
         ...
         rs1(1).Open "select count(rad) As rs1number from Mokhaberat WHERE (idmahsol=" + Trim(Str(rs1(0).Fields!idmahsol)) + ") and (rad=" + Trim(Str(rs1(0).Fields!rad)) + ")", db1
         ...
         rs1(2).Open "select * from infoMahsol WHERE idmahsol=" + Trim(Str(rs1(0).Fields!idmahsol)), db1
           If rs1number(1) > 0 Then
             db2.Open Form3.Text10.Text
               rs1(5).Open "UPDATE Mokhaberat SET [kodemahsol]='" + rs1(1).Fields!kodemahsol + "',[gothr]='" + rs1(1).Fields!gothr + "',[Size_1]='" + rs1(1).Fields!Size + "',[Name]='" + rs1(2).Fields!mahsol + "' WHERE (idmahsol=" + Trim(Str(rs1(0).Fields!idmahsol)) + ") and (rad = " + Trim(Str(rs1(0).Fields!rad)) + ")", db2
             db2.Close
           Else
             db2.Open Form3.Text10.Text
               sd2 = rs1(1).Fields!Size
               rs1(5).Open "INSERT INTO Mokhaberat (idmahsol,rad,name,kodemahsol,gothr,size_1) VALUES (" + Trim(Str(rs1(1).Fields!idmahsol)) + "," + Trim(Str(rs1(1).Fields!rad)) + ",'" + rs1(2).Fields!mahsol + "','" + rs1(1).Fields!kodemahsol + "','" + rs1(1).Fields!gothr + "','" + sd2 + "')", db2
             db2.Close
           End If
         rs1(1).Close
         rs1(2).Close
         ...
         If rs1number(3) > 0 Then
           rs1(3).Open "SELECT * FROM ozanmasir WHERE (idmahsol=" + Trim(Str(rs1(0).Fields!idmahsol)) + ") and (rad=" + Trim(Str(rs1(0).Fields!rad)) + ") ORDER BY rad1 ASC", db1
             rs1(3).Find "name= '„Œ«»—« Ì'", , adSearchForward, 1
             p = 0
             o = 0
...
'                       sd1 = " «»"
'                       db2.Open Form3.Text10.Text
'                         rs1(5).Open "INSERT INTO Mokhaberat1 (rad,Name,ghotr,vazn,mablag,fey) VALUES (" + Trim(Str(q)) + "," + sd1 + "," + Trim(Str(rs1(3).Fields!ghotr)) + "," + Trim(Str(rs1(3).Fields!naghlbebadmeghdar)) + "," + Trim(Str(rs1(3).Fields!naghlbebadmoney)) + "," + Trim(Str(sd)) + ")", db2
'                       db2.Close
                       q = q + 1
                     rs1(4).Close
                   End If
...
'                       db2.Close
              ...
              End Select
              db2.Open Form3.Text10.Text
                rs1(5).Open "UPDATE Mokhaberat SET [exist]='1' ,[tolidteydoremeghdar]='" + Trim(Str(p)) + "',[bahamavad]=" + Trim(Str(o)) + " WHERE (idmahsol=" + Trim(Str(rs1(3).Fields!idmahsol)) + ") and (rad=" + Trim(Str(rs1(3).Fields!rad)) + ")", db2
              db2.Close
             Else
              db2.Open Form3.Text10.Text
                rs1(5).Open "UPDATE Mokhaberat SET [exist]='0' WHERE (idmahsol=" + Trim(Str(rs1(3).Fields!idmahsol)) + ") and (rad=" + Trim(Str(rs1(3).Fields!rad)) + ")", db2
              db2.Close
             End If
           rs1(3).Close
         End If
...
db2.Open Form3.Text10.Text
  p = 0
  rs1(1).Open "select * from infomavad WHERE (soz='1')", db2
  rs1(1).MoveFirst
  Do
    rs1(2).Open "SELECT * FROM ghardeshmavad WHERE (nomade=1) and (idmade=" + Trim(Str(rs1(1).Fields!idmavad)) + ")", db2
    p = Val(p) + Val(rs1(2).Fields!masrafteydoremablagh)
    rs1(2).Close
    rs1(1).MoveNext
  Loop Until rs1(1).EOF = True
  rs1(1).Close

  rs1(0).Open "SELECT * FROM sarbar_4 WHERE rad =10", db2
  rs1(5).Open "UPDATE marahelnameasl SET [store1]='" + Trim(Str(w)) + "',[store2] ='" + rs1(0).Fields!dastmozd + "',[store3] ='" + Trim(Str(Val(rs1(0).Fields!sarbarvahed) + Val(rs1(0).Fields!sarbarjazb))) + "',[store4] ='" + rs1(0).Fields!estehlak + "',[store6] ='" + Trim(Str(p)) + "'  WHERE name= 'Mokhaberat'", db2
db2.Close

db1.Open Form3.Text10.Text
  rs1(3).Open "SELECT * FROM  marahelnameasl WHERE name= 'Mokhaberat'", db1
  rs1(0).Open "select count(rad) As rs1number from Mokhaberat", db1
    rs1number(0) = rs1(0).Fields!rs1number
  rs1(0).Close
  If rs1number(0) > 0 Then
    rs1(0).Open "select * from Mokhaberat ORDER BY idmahsol,rad ASC", db1
         ...
         If (Val(rs1(0).Fields!rad) <> 99999) Then
           ...
           If rs1(0).Fields!exist = 0 Then
             If (rs1(0).Fields!gothr <> 0) <> 0 Then
               rs1(2).Open "SELECT count(rad) As rs1number FROM Mokhaberat1 WHERE (ghotr='" + rs1(0).Fields!gothr + "')", db1
                 rs1number(2) = rs1(2).Fields!rs1number
               rs1(2).Close
               If (rs1number(2) > 0) Then
                 rs1(2).Open "SELECT * FROM Mokhaberat1 WHERE (ghotr='" + rs1(0).Fields!gothr + "')", db1
           ...
           If newq <> 0 Then
             ...
             r4 = ((Val(rs1(3).Fields!store6) / newq) * endmefield(0))
             endmefield(3) = Round(r4)
           ...
           endmefield(7) = Round(Val(endmefield(6)) + Val(endmefield(5)) + Val(endmefield(4)) + Val(endmefield(3)) + Val(endmefield(2)))
           ...
           db2.Open Form3.Text10.Text
             tmp1 = endmefield(0)
             tmp2 = endmefield(7)
             rs1(5).Open "UPDATE Mokhaberat SET [tolidteydoremeghdar]=" + endmefield(0) + ",[vaznmes]=" + tmp1 + ",[naghlbebadmeghdar]=" + endmefield(1) + ",[bahamavad]=" + endmefield(2) + ",[bahamavad1]=" + endmefield(3) + ",[dastmozd]=" + endmefield(4) + ",[sarbar]=" + endmefield(5) + ",[estelak]=" + endmefield(6) + ",[gheymattamam]=" + endmefield(7) + ",[tolidteydoremoney]=" + tmp2 + ",[naghlbebadmoney]=" + endmefield(8) + ",[mojodiendmoney]=" + endmefield(9) + " WHERE (idmahsol=" + Trim(Str(rs1(0).Fields!idmahsol)) + ") and (rad = " + Trim(Str(rs1(0).Fields!rad)) + ")", db2
           db2.Close
        End If
        rs1(0).MoveNext
     Loop Until rs1(0).EOF = True
...
Form39.Label1.Caption = 1
Form39.Show
End Sub

Private Sub Command3_Click()
Form39.Label1.Caption = 2
Form39.Show
End Sub

Private Sub Command4_Click()
Form39.Label1.Caption = 3
Form39.Show
End Sub
...
Form19.Adodc1.ConnectionString = Form3.Text10.Text
Form19.Adodc1.CommandType = adCmdUnknown
Form19.Adodc1.RecordSource = "select * from Mokhaberat ORDER BY idmahsol,rad ASC"
Form19.Adodc1.Refresh

Form3.Adodc2.Recordset.Find "name= 'Mokhaberat'", , adSearchForward, 1
...
Text1(4).Text = Form3.Adodc2.Recordset.Fields!store6
Label1.Caption = Val(Text1(0).Text) + Val(Text1(1).Text) + Val(Text1(2).Text) + Val(Text1(3).Text)

Combo1.Clear
Combo1.AddItem " „«„ „Õ’Ê·« "
db1.Open Form3.Text10.Text
  rs(0).Open "SELECT DISTINCT gothr FROM Mokhaberat WHERE (rad <> 99999) ORDER BY gothr", db1
    rs(0).MoveFirst
    Do
