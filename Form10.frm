...
Begin VB.Form Form10 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.ListBox List1 
         Height          =   4545
         ItemData        =   "Form10.frx":2D4E
         Left            =   120
         List            =   "Form10.frx":2D79
         RightToLeft     =   -1  'True
         TabIndex        =   11
         Top             =   480
         Width           =   1335
...
Do
  If Form9.Adodc1.Recordset.Fields!Name = "À«‰ÊÌÂ" Then
...
Form3.Adodc2.Recordset.Find "name='sanaveye'", , adSearchForward, 1
...
Form10.Text1(0).Text = Form3.Adodc2.Recordset.Fields!store1
Form10.Text1(1).Text = Form3.Adodc2.Recordset.Fields!store2
Form10.Text1(2).Text = Form3.Adodc2.Recordset.Fields!store3
Form10.Text1(3).Text = Form3.Adodc2.Recordset.Fields!store4
...
Adodc3.RecordSource = "select * from sanaveye ORDER BY rad ASC"
Adodc3.Refresh

Adodc3.Refresh
Adodc3.Recordset.MoveFirst
Do
   If (Val(Adodc3.Recordset.Fields!rad) <> 99999) And (Val(Adodc3.Recordset.Fields!rad) <> 99998) And (Val(Adodc3.Recordset.Fields!rad) <> 99997) Then
      'ÃœÊ· „ﬁœ«—Ì
      If Adodc3.Recordset.Fields!Name = "‰Â«ÌÌ" Then
        Form11.Adodc3.ConnectionString = Form3.Text10.Text
        Form11.Adodc3.CommandType = adCmdUnknown
        Form11.Adodc3.RecordSource = "select * from nahaee WHERE (rad=99999)"
        Form11.Adodc3.Refresh
        
        Adodc3.Recordset.Fields!naghlbebadmeghdar = Form11.Adodc3.Recordset.Fields!tolidteydoremeghdar
        
      ElseIf Adodc3.Recordset.Fields!Name = "òÊ—Â" Then
...
Form31.Label1.Caption = 1
Form31.Show
End Sub

Private Sub Command3_Click()
Form31.Label1.Caption = 2
Form31.Show
End Sub

Private Sub Command4_Click()
Form31.Label1.Caption = 3
Form31.Show
End Sub
...
List1.Visible = False
Form10.Adodc1.ConnectionString = Form3.Text10.Text
Form10.Adodc1.CommandType = adCmdUnknown
Form10.Adodc1.RecordSource = "select * from sanaveye ORDER BY rad ASC"
