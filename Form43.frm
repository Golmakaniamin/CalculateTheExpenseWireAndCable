...
Dim Report1 As New bancher1
Dim Report2 As New bancher2
Dim Report3 As New bancher3
...
If Label1.Caption = 2 Then
  ...
  Report2.Text15.SetText Form28.Text1(0).Text
  Report2.Text17.SetText Form28.Text1(1).Text
  Report2.Text21.SetText Form28.Text1(2).Text
  Report2.Text20.SetText Form28.Text1(3).Text
